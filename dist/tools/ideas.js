...
export function registerIdeasTools(server, client) {
    server.registerTool("paul_ideas", {
        ...
        description: "List the team's idea board — product feedback about PAUL itself — " +
    ...
    server.registerTool("paul_create_idea", {
        title: "Propose an idea to improve PAUL (historical board)",
        description: "Post an idea to PAUL's improvement board. PREFER paul_create_request " +
    ...
    server.registerTool("paul_vote_idea", {
        title: "Upvote an idea on PAUL's board",
        description: "Upvote an idea from paul_ideas by its id. Check the idea's `voted` " +
