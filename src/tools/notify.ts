 ...
 */
export function registerConfirmNotifiedTool(server: McpServer, client: PaulClient): void {
  server.registerTool(
    "paul_confirm_notified",
    {
      title: "Confirm you already told the client the work is done",
      description:
        "Close a task that is parked waiting for its REQUESTER to confirm the " +
